import { CacheOptions, ContractIndex, ContractExtraOptions, ContractCustomDecorator, ContractIndexOptions, ContractMessageProperty, ContractLink } from '../decorators/contract.decorator';
export declare class IContract {
    namespace?: string;
    isPublic?: boolean;
    contractName: string;
...
export declare class IContractField {
    propertyKey: string;
    protoType: string;
...
export declare class IContractMessage {
    propertyKey: string;
    name: string;
    properties: Record<string, ContractMessageProperty>;
}
export declare class IContractService {
    propertyKey: string;
    name: string;
    path: string;
...
export declare class IContractIndex {
    name: string;
    fields: Array<any>;
